      ...
      {resumes.data?.length > 0 && (
        <ul className="divide-y divide-border-subtle rounded-xl border border-border-subtle bg-surface">
          {resumes.data.map((resume) => (
            <li key={resume.id} className="flex flex-wrap items-center gap-3 px-4 py-3">
              <div className="min-w-0 flex-1">
                ...
                <p className="mt-0.5 text-xs text-ink-muted">
                  ...
                  {resume.years_experience && ` · ${resume.years_experience} yrs detected`}
